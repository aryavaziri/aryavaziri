...
- Full-stack applications with React, Next.js, TypeScript, Node.js, and SQL-backed data models
- ERP modules, admin dashboards, internal tools, and configurable business workflows
...
I am especially interested in projects that need end-to-end ownership across frontend, backend, databases, infrastructure, and business logic.

Good fits include ERP systems, SaaS platforms, internal operations tools, technical configuration systems, and data-heavy web applications.

<!--
aryavaziri/aryavaziri is the special GitHub profile repository. Its README appears on the public GitHub profile.
-->
